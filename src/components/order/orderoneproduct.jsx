  ...
  {isViewMode ? (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 to-amber-100 p-6">
      ...
      <button
        ...
        className="fixed left-6 top-6 z-50 flex items-center space-x-2 bg-white/90 backdrop-blur-md px-4 py-2 rounded-full shadow-lg border border-amber-200 hover:shadow-xl transition-all"
      >
        <svg 
      ...
      <div className="max-w-4xl mx-auto mt-16">
        {/* Glowing Header */}
        <div className="relative bg-gradient-to-r from-amber-400 to-amber-500 p-8 rounded-t-2xl shadow-lg overflow-hidden">
          ...
          <h1 className="text-3xl font-bold text-white relative z-10">Order Summary</h1>
          <div className="absolute -right-10 -top-10 w-32 h-32 bg-white/20 rounded-full"></div>
          <div className="absolute -bottom-10 -left-10 w-40 h-40 bg-amber-300/20 rounded-full"></div>
        </div>
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-b-2xl shadow-xl border border-white/50 overflow-hidden">
          <div className="p-8">
            {/* Product Card */}
            <div className="flex flex-col md:flex-row items-center gap-8 pb-8 mb-8 border-b border-amber-100/50">
              <div className="relative group">
                ...
                <img
                  ...
                  className="w-40 h-40 object-cover rounded-xl border-2 border-white shadow-lg transform group-hover:scale-105 transition-transform"
                />
              </div>
              ...
              <div className="flex-1">
                ...
                <p className="text-lg text-gray-600 mt-2">Quantity: {!!isCartItembull ? quantitybull : 1}</p>
            ...
            <div className="relative bg-gradient-to-br from-amber-50 to-white p-8 rounded-xl border border-amber-100/50 mb-8 shadow-sm overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="flex justify-between items-center mb-6">
                  ...
                  <button 
                    ...
                    className="bg-gradient-to-r from-amber-500 to-amber-600 text-white px-6 py-2 rounded-lg hover:from-amber-600 hover:to-amber-700 transition-all shadow-md hover:shadow-lg flex items-center"
                  >
                ...
                <div className="space-y-4 text-gray-700 text-lg">
                  ...
                  <p className="flex items-center gap-3">
                    <span className="font-semibold text-amber-700 min-w-[80px]">Phone:</span> 
                    <span>{address?.phonenumber || "N/A"}</span>
                  </p>
                  <p className="flex items-start gap-3">
                    <span className="font-semibold text-amber-700 min-w-[80px] mt-1">Address:</span> 
                    <span>
            ...
            <div className="bg-white p-8 rounded-xl border border-amber-100/50 shadow-sm relative overflow-hidden">
              <div className="absolute -right-10 -top-10 w-32 h-32 bg-amber-200/10 rounded-full"></div>
              ...
              <div className="border-t border-amber-100/50 pt-6 mb-8">
              ...
              <button 
                ...
                className="w-full bg-gradient-to-r from-amber-500 to-amber-600 text-white py-4 rounded-lg font-bold hover:from-amber-600 hover:to-amber-700 transition-all shadow-lg hover:shadow-xl transform hover:scale-[1.02] active:scale-95 flex items-center justify-center"
              >
    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 to-amber-100 flex items-center justify-center p-6">
      <div className="w-full max-w-2xl bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl overflow-hidden border border-white/50">
        {/* Shining Header */}
        <div className="relative bg-gradient-to-r from-amber-400 to-amber-500 p-8 overflow-hidden">
          <div className="absolute inset-0 bg-[url('https://assets.website-files.com/5e51b3b0337309d672efd94c/5e51cc5933d36821a19c9d8f_Group%2015.svg')] opacity-20"></div>
          <h2 className="text-2xl font-bold text-white relative z-10">Update Delivery Address</h2>
          <div className="absolute -right-10 -top-10 w-32 h-32 bg-white/20 rounded-full"></div>
        </div>
        ...
        <div className="p-8 space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block text-lg font-medium text-amber-700 mb-2">Name</label>
              <input
                type="text"
                onChange={(e) => setUpaddress({ name: 'nameofuser', value: e.target.value })}
                className="w-full p-4 border border-amber-200/50 rounded-lg focus:ring-2 focus:ring-amber-400 focus:border-transparent bg-white/50 backdrop-blur-sm text-lg shadow-sm"
                placeholder="Your Name"
                required
              />
            </div>
            <div>
              <label className="block text-lg font-medium text-amber-700 mb-2">Phone Number</label>
              <input
                type="number"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              <label className="block text-lg font-medium text-amber-700 mb-2">Pincode</label>
              <input
                type="number"
            ...
            <div>
              <label className="block text-lg font-medium text-amber-700 mb-2">State</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-lg font-medium text-amber-700 mb-2">City</label>
              <input
                type="text"
          ...
          <div>
            <label className="block text-lg font-medium text-amber-700 mb-2">House/Building</label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-lg font-medium text-amber-700 mb-2">Road/Area</label>
            <input
              type="text"
          ...
          <div className="flex gap-6 pt-6">
            <button
              ...
              className="flex-1 bg-gradient-to-r from-amber-500 to-amber-600 text-white py-4 rounded-lg font-bold hover:from-amber-600 hover:to-amber-700 transition-all shadow-lg hover:shadow-xl transform hover:scale-[1.02] active:scale-95"
            >
              Save Address
            </button>
            <button
              onClick={handleToggle}
              className="flex-1 bg-gradient-to-r from-gray-500 to-gray-600 text-white py-4 rounded-lg font-bold hover:from-gray-600 hover:to-gray-700 transition-all shadow-lg hover:shadow-xl transform hover:scale-[1.02] active:scale-95"
            >
              Cancel
            </button>
          </div>
