...
//     console.log('func')
// }
// let oneByoneOrderFunc=()=>{
//     console.log('oneByoneOrderFunc')
// }
        ...
        <div style={{ backgroundImage: `url(${bgimage})` }}className="bg-center bg-cover min-h-screen bg-no-repeat p-6">
            ...
            {cartItems.map((item, index) => (
              <div key={index} className="bg-white border border-gray-200 rounded-2xl p-4 shadow hover:scale-105 transition-transform duration-300">
                ...
                <div className="flex justify-around items-center">
                  {/* <button onClick={oneByoneOrderFunc}className="px-4 py-2 rounded-lg bg-yellow-400 text-black hover:bg-yellow-300 transition-colors font-semibold">Order</button> */}
                  {/* <button onClick={() => func( item.id)}className="px-3 py-2 rounded-lg bg-yellow-400 text-black hover:bg-yellow-300 font-semibold">Increase</button> */}
                  {/* <span className="px-2 text-black font-semibold">{item.quantity}</span> */}
                  {/* <button onClick={func} className="px-3 py-2 rounded-lg bg-yellow-400 text-black hover:bg-yellow-300 font-semibold">Decrease</button> */}
                </div>
              </div>))}
          </div>
          ...
          {/* <div className="fixed bottom-0 left-0 w-full border-t border-gray-300 shadow-md bg-white z-50">
            <div className="max-w-6xl mx-auto px-4 py-3 flex flex-col md:flex-row items-center justify-between gap-4">
              ...
              <button className="w-full md:w-auto bg-green-600 text-white py-3 px-6 rounded-lg text-lg font-semibold hover:bg-green-700 transition">Place All Orders</button>
            </div>
          </div> */}
        </div>
